...
- Normalize into [domain models](../architecture/domain-models.md) and compute metrics on the fly.
...
_See [System design](../architecture/system-design.md) for the caching table and request flow._
